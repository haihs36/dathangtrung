...
class TbShippingSearch extends TbShipping
{
    ...
    public function rules()
    {
        return [
            ...
            [['shippingCode','barcode','isCheck','isBox', 'tranID', 'createDate','startDate', 'endDate'], 'safe'],
    ...
    */
    ...
    {
        $this->load($params);
        $query = TbShipping::find()->select('a.*,b.orderID,o.identify,o.isBox,o.isCheck,p.name,c.username')
