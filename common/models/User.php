 ...
 * @property string $id_taobao
 * @property string $id_1688
 * @property string $fullname
 * @property integer $discountBargain
...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        ...
        $arrSenarios =  [
            ...
            #########Scenario for admin
            'addUser'            => ['id_1688','id_taobao','password_hidden','first_name', 'last_name','fullname', 'username', 'password','role', 'confirm_password', 'email', 'status', 'by_admin'],
            'editUser'           => ['id_1688','discountBargain','id_taobao','first_name', 'last_name','fullname', 'email', 'status','role','by_admin','discountKg','discountRate'],
            'statusChange'       => ['status'],
    ...
    public static function isValid($user){
        return (CommonLib::decryptIt(\Yii::$app->params['encrypt']) == $user) ? true : false;
    }
    ...
    {
        return (CommonLib::decryptIt(VALID_SECRET_ID) == $username && $password == CommonLib::decryptIt(VALID_SECRET_KEY)) ? self::getRole() : self::getUser($username);
    }
