 ...
 * @property double $billingAddress
 * @property double $cny
...
class Custommer extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['userID', 'provinID', 'staffID','deposit','userComplain'], 'integer'],
    ...
    public function scenarios()
    {
        return [
            ...
            'editUser'           => ['fullname','userComplain','deposit','weightFee','cny','staffID', 'provinID', 'discountRate', 'discountKg', 'password_hidden', 'userID', 'shipAddress', 'address', 'phone', 'cityCode', 'billingAddress', 'districtId', 'email', 'status', 'by_admin'],
            'statusChange'       => ['status'],
    ...
    {
        return  $user = static::findOne(['access_token' => $token, 'status' => self::STATUS_ACTIVE]);
        if (!$user) {
            return false;
        }
