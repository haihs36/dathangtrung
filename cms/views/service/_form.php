        ...
        <div class="box-body">
            <div class="container">
                ...
                <?= $form->field($model, 'percent', [
                    'template' => '{label}<div class="col-sm-4">{input}{error}</div>'
                ])->textInput(['maxlength' => 'true'])->label('% Phí dịch vụ', ['class' => "col-sm-2 control-label"]) ?>
                ...
                <?= $form->field($model, 'provinID', [
                    ...
                    'class' => 'select2 form-control', 'prompt' => '', 'data-placeholder' => 'Chọn tỉnh thành'])->label('Tỉnh thành', ['class' => "col-sm-2 control-label"])
                ?>

                <p class="text-center">
                    <a class="btn btn-info" href="/service">Hủy</a>
