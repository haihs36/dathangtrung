    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <?php echo $form->field($model, 'confirm_password')->textInput(['placeholder'=>'Xác nhận mật khẩu'])->label($model->getAttributeLabel('Xác nhận mật khẩu'));?>
                <?php echo Html::submitButton('Thay đổi', ['class'=>'btn btn-success']);?>
            </div>
        </div>
        <?php ActiveForm::end();?>
