...
$customer = isset($model->customer) ? $model->customer : false;
?>
<div class=" payment-support-form" >
    <div class="header">
        <h3>Tên khách hàng: <?= $customer ? $customer->fullname.' (<b>'.$customer->username.'</b>)' : '' ?></h3>
    </div>
    <div class="box-body ">
        <div id="fieldList">
            <div class="itemList">
    ...
    <div class="box-footer text-center">
        ...
        <div class="col-md-8 text-right"><a href="/paymentsupport/index" class="btn btn-primary">Quay lại</a></div>
    </div>
</div>
