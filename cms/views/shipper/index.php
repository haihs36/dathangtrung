            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        if(isset($model->customer->username) && Yii::$app->user->identity->role == ADMIN){
                            return '<a title="Chi tiết" target="_blank" href="' . \yii\helpers\Url::toRoute(['customer/view', 'id' => $model->userID], true) . '" ><b>' .$model->customer->fullname. '</b></a><br>'.$model->customer->username;
                        }
