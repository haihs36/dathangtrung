                            ...
                            <table class="table table-bordered table-summary table-hover">
                                ...
                                <tr>
                                    <td class="border-top  collapsed-b">
                                        ...
                                        ?>
                                        <div class="rows" style="overflow-y: auto;max-height: 325px;">
                                            <table class="shop-process table-striped">
                                                <tr>
                                                      <td colspan="2">
                                                        
                                                         <div class="clear text-center  box-kien pt15">
                                                           <label class="checkbox icheck">
                                                            ...
                                                            <label>
                                                                <input  type="checkbox" value="1" <?= ($currentOrder->vct) ? 'checked' : '' ?> name="isVCT"> VCT
                                                            </label>
                                                            </label>
                                                            <label class="checkbox icheck pr5">
                                                                <label>
                                                                    <input  type="checkbox" value="1" <?= ($currentOrder->vctk) ? 'checked' : '' ?> name="isVCTK"> VCTK
                                                                </label>
                                                            </label>
                                                            <label class="checkbox icheck">
                                                                <label>
                                                                    <input  type="checkbox" value="1" <?= ($currentOrder->vcn) ? 'checked' : '' ?> name="isVCN"> VCN
                                                                </label>
                                                            </label>
                                                ...
                                                <tr> <td colspan="2" style="height: 5px;"><br></td></tr>
                                                <tr>
                                                    <td valign="top" style="max-height: 325px;">
                                                        <p class="clear">
                                                ...
                                                <tr>
                                                     <td colspan="2">
                                                        ...
                                                        ?>
                                                        <textarea id="KHO_QC" style="width: 100%"><?= $khoqc  ?></textarea>
                                ...
                                <div class="chat_message_area">
                                    ...
                                    <div class="form-group text-right" style="margin-top:5px;position: relative">
                                        ...
                                        <div class="image_upload">
                                            ...
                                            <?= $formUpload->field($uploadForm, 'file')->fileInput(['id' => 'uploadFile'])->label(false) ?>
                                            <?php ActiveForm::end() ?>
