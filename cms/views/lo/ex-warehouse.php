...
<div class="bg-white">
    <div class="box-header text-center">
        ...
        <p>Loại hàng: <b><?= !empty($loInfo['payType']) ? \common\components\CommonLib::paymentType($loInfo['payType']) : 'Hàng order' ?></b></p>
    </div><!-- /.box-header -->
    <div class="box-body table-responsive no-padding pd10">
            ...
            <div class="grid-view pd10">
                <table class="table table-bordered table-condensed table-hover small kv-table text-center">
                    ...
                    <tr>
                        ...
                        <td>Tiền cân nặng</td>
                        <td class="vnd-unit"><?= number_format($totalKgPrice) ?> <em class="red">đ</em></td>
                        <td>Số dư ví hiện tại</td>
                        <td class="vnd-unit"><?= number_format($loInfo['totalResidual']) ?> <em class="red">đ</em></td>
                    </tr>
                    <tr>
                        <td>Số điện thoại</td>
                        <td><?= $loInfo['phone'] ?></td>
                        <td>Phí đóng gỗ</td>
                        <td class="vnd-unit"><?= number_format($phidonggo) ?><em class="red">đ</em></td>
                        <td>Tổng thanh toán</td>
                        <td class="vnd-unit"><?= number_format($loInfo['amount']) ?> <em class="red">đ</em></td>
                    </tr>
                    <tr>
                        <td rowspan="2">Địa chỉ</td>
                        <td rowspan="2"><?= $loInfo['billingAddress'] ?></td>
                        <td>Phí phát sinh: </td>
                        <td class="vnd-unit"><?= number_format($loInfo['shipFee']) ?> <em class="red">đ</em></td>
                        <td>Hình thức giao hàng</td>
                        <td><?= \common\components\CommonLib::paymentStatus($loInfo['payStatus']) ?></td>
                    </tr>
                    <tr>
                        <td>Phí kiểm đếm</td>
                        <td class="vnd-unit"><?= number_format($phikiemhang) ?><em class="red">đ</em></td>
        ...
        <p class="text-center">
            <a target="_blank" data-url="<?= \yii\helpers\Url::toRoute(['payment/print','loid'=>$loInfo['id']]) ?>" title="print" href="javascript:void(0)" class="btn-print btn btn-info">
