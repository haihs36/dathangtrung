...
<div class="lo-index clear">
    ...
    <?= GridView::widget([
        ...
        'toolbar' => [
            ['content'=>
                Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['consignment/index'], ['data-pjax'=>false, 'class' => 'btn btn-default', 'title'=>'Reset Grid'])
            ],
            '{export}',
        ],
        'panel' => [
            'heading'=>'<h3 class="panel-title"><i class="fa fa-cart-arrow-down"></i> Danh sách phiếu xuất </h3>',
        ...
        'columns' => [
            ...
            [
                ...
                'detailUrl' => \yii\helpers\Url::to(['consignmentdetail/parents']),
                'headerOptions' => ['class' => 'kartik-sheet-style'],
                'expandOneOnly' => true
            ],
            [
...
//                'headerOptions'  => ['style' => 'width: 10%;'],
                ...
                'format'        => 'raw',
                'value'         => function ($model) {
                    return date('d-m-Y H:i:s', strtotime($model->create));
                }
            ],
            [
